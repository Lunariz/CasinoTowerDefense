...
public class DrawingHelper
{
    ...
    protected static SpriteSheet pixelSprite;
    ...
    public static void DrawRectangleFilled(Rectangle r, SpriteBatch spriteBatch, Color col)
    {
        spriteBatch.Draw(pixel, new Rectangle((int)r.X, (int)r.Y, r.Width, r.Height), col);
    }
}
