...
public class GameEnvironment : Game
{
    ...
    protected override void LoadContent()
    {
        ...
        Debug.Print("Viewport width:" + GraphicsDevice.Viewport.Width + ", viewport height: " + GraphicsDevice.Viewport.Height);
    ...
    protected override void Draw(GameTime gameTime)
    {
        ...
        spriteBatch.Begin(SpriteSortMode.FrontToBack, null, null, null, null, null, camera.TransformMatrix * spriteScale);
